...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steep-unit-c7e3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/steep-unit-c7e3
```

A live public deployment of this template is available at [https://steep-unit-c7e3.templates.workers.dev](https://steep-unit-c7e3.templates.workers.dev)
